...
int open_listenfd(int port)
{
    ...
    {
        log_err("invalid port number %d, uses the default port number %d", port, DEFAULT_PORT_NUMBER);
...
/*
    make a socket non blocking. If a listen socket is a blocking socket, after it comes out from epoll and
    accepts the last connection, the next accept will block, which is not what we want
*/
